...
export interface KS_AWS_EC2_00068Props {}

const KS_AWS_EC2_00068: React.FC<KS_AWS_EC2_00068Props> = () => {
  return (
    <CustomFlexBox>
      <PageTitle title="Data Protection | ALB with old TLS version" />
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">ALB with old TLS version</H1>
...
export default KS_AWS_EC2_00068;

...
export interface KS_AWS_RDS_00071Props {}

const KS_AWS_RDS_00071: React.FC<KS_AWS_RDS_00071Props> = () => {
  return (
    <CustomFlexBox>
      <PageTitle title="Data Protection | RDS publicly accessible" />
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">RDS publicly accessible</H1>
...
export default KS_AWS_RDS_00071;

...
export interface KS_AWS_RDS_00073Props {}

const KS_AWS_RDS_00073: React.FC<KS_AWS_RDS_00073Props> = () => {
  return (
    <CustomFlexBox>
      <PageTitle title="Infrastructure | No autoscaling storage configured for RDS database" />
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">No autoscaling storage configured for RDS database</H1>
        <Span>Prevent data loss and interruption of service</Span>
		...
		No autoscaling storage configured for RDS database
        </Paragraph>
...
export default KS_AWS_RDS_00073;

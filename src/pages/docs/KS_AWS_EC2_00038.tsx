...
export interface KS_AWS_EC2_00038Props {}

const KS_AWS_EC2_00038: React.FC<KS_AWS_EC2_00038Props> = () => {
  return (
    <CustomFlexBox>
      <PageTitle title="Logging and Monitoring | EC2 without detailed monitoring" />
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">EC2 without detailed monitoring</H1>
...
export default KS_AWS_EC2_00038;

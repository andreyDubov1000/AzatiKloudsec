...
export interface KS_AWS_EC2_00041Props {}

const KS_AWS_EC2_00041: React.FC<KS_AWS_EC2_00041Props> = () => {
  return (
    <CustomFlexBox>
      <PageTitle title="Data Protection | EC2 user data contains secrets" />
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">EC2 user data contains secrets</H1>
		...
		EC2 user data contains secrets
        </Paragraph>
...
export default KS_AWS_EC2_00041;

...
export interface KS_AWS_EC2_00032Props {}

const KS_AWS_EC2_00032: React.FC<KS_AWS_EC2_00032Props> = () => {
  return (
    <CustomFlexBox>
      <PageTitle title="Data Protection | Unencrypted ami" />
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">Unencrypted ami</H1>
...
export default KS_AWS_EC2_00032;

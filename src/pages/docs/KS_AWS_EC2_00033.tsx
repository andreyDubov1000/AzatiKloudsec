...
export interface KS_AWS_EC2_00033Props {}

const KS_AWS_EC2_00033: React.FC<KS_AWS_EC2_00033Props> = () => {
  return (
    <CustomFlexBox>
      <PageTitle title="Data Protection | Unencrypted snapshot" />
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">Unencrypted snapshot</H1>
...
export default KS_AWS_EC2_00033;

...
export interface KS_AWS_CONFIG_00101Props {}

const KS_AWS_CONFIG_00101: React.FC<KS_AWS_CONFIG_00101Props> = () => {
  return (
    <CustomFlexBox>
      <PageTitle title="Logging and Monitoring | AWS Config service is disabled or no active recorder on this region" />
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">AWS Config service is disabled or no active recorder on this region</H1>
...
export default KS_AWS_CONFIG_00101;

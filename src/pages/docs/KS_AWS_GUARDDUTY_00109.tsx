...
export interface KS_AWS_GUARDDUTY_00109Props {}

const KS_AWS_GUARDDUTY_00109: React.FC<KS_AWS_GUARDDUTY_00109Props> = () => {
  return (
    <CustomFlexBox>
      <PageTitle title="Logging and Monitoring | AWS GuardDuty service is disabled on this region" />
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">AWS GuardDuty service is disabled on this region</H1>
		...
		AWS GuardDuty service is disabled on this region
        </Paragraph>
...
export default KS_AWS_GUARDDUTY_00109;

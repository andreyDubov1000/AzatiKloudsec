...
export interface KS_AWS_EC2_00031Props {}

const KS_AWS_EC2_00031: React.FC<KS_AWS_EC2_00031Props> = () => {
  return (
    <CustomFlexBox>
      <PageTitle title="Data Protection | Public ami" />
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">Public ami</H1>
...
export default KS_AWS_EC2_00031;

...
export interface KS_AWS_RDS_00115Props {}

const KS_AWS_RDS_00115: React.FC<KS_AWS_RDS_00115Props> = () => {
  return (
    <CustomFlexBox>
      <PageTitle title="Data Protection | RDS Cluster Deletion Protection Disabled" />
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">RDS Cluster Deletion Protection Disabled</H1>
...
export default KS_AWS_RDS_00115;

...
export interface KS_AWS_GLUE_00104Props {}

const KS_AWS_GLUE_00104: React.FC<KS_AWS_GLUE_00104Props> = () => {
  return (
    <CustomFlexBox>
      <PageTitle title="Data Protection | Glue Data Catalog Encryption is Disabled" />
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">Glue Data Catalog Encryption is Disabled</H1>
		...
		Glue Data Catalog Encryption is Disabled
        </Paragraph>
...
export default KS_AWS_GLUE_00104;

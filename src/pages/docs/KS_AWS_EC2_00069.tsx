...
export interface KS_AWS_EC2_00069Props {}

const KS_AWS_EC2_00069: React.FC<KS_AWS_EC2_00069Props> = () => {
  return (
    <CustomFlexBox>
      <PageTitle title="Data Protection | ALB with non HTTPS listeners" />
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">ALB with non HTTPS listeners</H1>
...
export default KS_AWS_EC2_00069;

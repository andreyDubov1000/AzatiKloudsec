...
export interface KS_AWS_SAGEMAKER_00102Props {}

const KS_AWS_SAGEMAKER_00102: React.FC<KS_AWS_SAGEMAKER_00102Props> = () => {
  return (
    <CustomFlexBox>
      <PageTitle title="Data Protection | Sagemaker notebook publicly accessible" />
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">Sagemaker notebook publicly accessible</H1>
		...
		Sagemaker notebook publicly accessible
        </Paragraph>
...
export default KS_AWS_SAGEMAKER_00102;

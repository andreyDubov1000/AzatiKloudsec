...
export interface KS_AWS_S3_00067Props {}

const KS_AWS_S3_00067: React.FC<KS_AWS_S3_00067Props> = () => {
  return (
    <CustomFlexBox>
      <PageTitle title="Data Protection | Public s3 bucket" />
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">Public s3 bucket</H1>
...
export default KS_AWS_S3_00067;

...
export interface KS_AWS_CLOUDFRONT_00094Props {}

const KS_AWS_CLOUDFRONT_00094: React.FC<KS_AWS_CLOUDFRONT_00094Props> = () => {
  return (
    <CustomFlexBox>
      <PageTitle title="Infrastructure | CloudFront distribution does not have WAF enabled" />
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">CloudFront distribution does not have WAF enabled</H1>
...
export default KS_AWS_CLOUDFRONT_00094;

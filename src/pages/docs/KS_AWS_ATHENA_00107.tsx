...
export interface KS_AWS_ATHENA_00107Props {}

const KS_AWS_ATHENA_00107: React.FC<KS_AWS_ATHENA_00107Props> = () => {
  return (
    <CustomFlexBox>
      <PageTitle title="Data Protection | Athena workgroup query results are not encrypted" />
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">Athena workgroup query results are not encrypted</H1>
		...
		Athena workgroup query results are not encrypted
        </Paragraph>
...
export default KS_AWS_ATHENA_00107;

...
export interface KS_AWS_SQS_00083Props {}

const KS_AWS_SQS_00083: React.FC<KS_AWS_SQS_00083Props> = () => {
  return (
    <CustomFlexBox>
      <PageTitle title="Data Protection | SQS queue not encrypted" />
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">SQS queue not encrypted</H1>
...
export default KS_AWS_SQS_00083;

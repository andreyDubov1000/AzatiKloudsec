...
export interface KS_AWS_COMPUTE-OPTIMIZER_00127Props {}

const KS_AWS_COMPUTE-OPTIMIZER_00127: React.FC<KS_AWS_COMPUTE-OPTIMIZER_00127Props> = () => {
  return (
    <CustomFlexBox>
      ...
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">Compute Optimizer has some findings that needs attention</H1>
...
export default KS_AWS_COMPUTE-OPTIMIZER_00127;

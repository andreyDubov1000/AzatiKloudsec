...
export interface KS_AWS_COMPUTE_OPTIMIZER_00127Props {}

const KS_AWS_COMPUTE_OPTIMIZER_00127: React.FC<KS_AWS_COMPUTE_OPTIMIZER_00127Props> =
  () => {
    return (
      <CustomFlexBox>
        <PageTitle title="Infrastructure | Compute Optimizer has some findings that needs attention" />
        <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
          <H1 mb="0.75rem">
            Compute Optimizer has some findings that needs attention
          </H1>
          ...
          <Paragraph lineHeight="1.625" mb="1.75rem"></Paragraph>

          <H2 mb="0.75rem" mt="1.75rem">
            How to fix the problem using AWS CLI
          </H2>
          <Paragraph lineHeight="1.625" mb="1rem"></Paragraph>
...
export default KS_AWS_COMPUTE_OPTIMIZER_00127;

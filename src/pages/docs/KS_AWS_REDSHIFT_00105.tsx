...
export interface KS_AWS_REDSHIFT_00105Props {}

const KS_AWS_REDSHIFT_00105: React.FC<KS_AWS_REDSHIFT_00105Props> = () => {
  return (
    <CustomFlexBox>
      <PageTitle title="Data Protection | Redshift cluster Data Encryption is Disabled" />
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">Redshift cluster Data Encryption is Disabled</H1>
		...
		Redshift cluster Data Encryption is Disabled
        </Paragraph>
...
export default KS_AWS_REDSHIFT_00105;

...
export interface KS_AWS_MACIE_00126Props {}

const KS_AWS_MACIE_00126: React.FC<KS_AWS_MACIE_00126Props> = () => {
  return (
    <CustomFlexBox>
      <PageTitle title="Data Protection | AWS Macie service has not acknowledged findings" />
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">AWS Macie service has not acknowledged findings</H1>
		...
		AWS Macie service has not acknowledged findings
        </Paragraph>
...
export default KS_AWS_MACIE_00126;

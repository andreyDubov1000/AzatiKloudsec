...
export interface KS_AWS_ES_00074Props {}

const KS_AWS_ES_00074: React.FC<KS_AWS_ES_00074Props> = () => {
  return (
    <CustomFlexBox>
      <PageTitle title="Data Protection | Elasticsearch publicly accessible" />
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">Elasticsearch publicly accessible</H1>
...
export default KS_AWS_ES_00074;

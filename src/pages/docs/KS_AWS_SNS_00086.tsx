...
export interface KS_AWS_SNS_00086Props {}

const KS_AWS_SNS_00086: React.FC<KS_AWS_SNS_00086Props> = () => {
  return (
    <CustomFlexBox>
      <PageTitle title="Data Protection | SNS topic not encrypted" />
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">SNS topic not encrypted</H1>
...
export default KS_AWS_SNS_00086;

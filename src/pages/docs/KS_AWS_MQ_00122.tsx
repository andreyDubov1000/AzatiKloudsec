...
export interface KS_AWS_MQ_00122Props {}

const KS_AWS_MQ_00122: React.FC<KS_AWS_MQ_00122Props> = () => {
  return (
    <CustomFlexBox>
      <PageTitle title="Data Protection | AWS MQ broker is publicly accessible" />
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">AWS MQ broker is publicly accessible</H1>
		...
		AWS MQ broker is publicly accessible
        </Paragraph>
...
export default KS_AWS_MQ_00122;

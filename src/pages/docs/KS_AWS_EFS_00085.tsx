...
export interface KS_AWS_EFS_00085Props {}

const KS_AWS_EFS_00085: React.FC<KS_AWS_EFS_00085Props> = () => {
  return (
    <CustomFlexBox>
      <PageTitle title="Data Protection | EFS is not encrypted" />
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">EFS is not encrypted</H1>
...
export default KS_AWS_EFS_00085;

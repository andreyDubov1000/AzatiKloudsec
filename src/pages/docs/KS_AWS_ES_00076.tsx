...
export interface KS_AWS_ES_00076Props {}

const KS_AWS_ES_00076: React.FC<KS_AWS_ES_00076Props> = () => {
  return (
    <CustomFlexBox>
      <PageTitle title="Data Protection | Elasticsearch node to node encryption not configured" />
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">Elasticsearch node to node encryption not configured</H1>
		...
		Elasticsearch node to node encryption not configured
        </Paragraph>
...
export default KS_AWS_ES_00076;

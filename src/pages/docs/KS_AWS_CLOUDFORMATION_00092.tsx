...
export interface KS_AWS_CLOUDFORMATION_00092Props {}

const KS_AWS_CLOUDFORMATION_00092: React.FC<KS_AWS_CLOUDFORMATION_00092Props> = () => {
  return (
    <CustomFlexBox>
      <PageTitle title="Data Protection | Cloudformation output expose secrets" />
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">Cloudformation output expose secrets</H1>
		...
		Cloudformation output expose secrets
        </Paragraph>
...
export default KS_AWS_CLOUDFORMATION_00092;

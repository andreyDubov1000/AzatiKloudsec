...
export interface KS_AWS_CT_00082Props {}

const KS_AWS_CT_00082: React.FC<KS_AWS_CT_00082Props> = () => {
  return (
    <CustomFlexBox>
      <PageTitle title="Data Protection | Trail not encrypted" />
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">Trail not encrypted</H1>
...
export default KS_AWS_CT_00082;

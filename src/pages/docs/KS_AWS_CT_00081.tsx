...
export interface KS_AWS_CT_00081Props {}

const KS_AWS_CT_00081: React.FC<KS_AWS_CT_00081Props> = () => {
  return (
    <CustomFlexBox>
      <PageTitle title="Logging and Monitoring | Trail not unabled for multi region" />
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">Trail not unabled for multi region</H1>
		...
		Trail not unabled for multi region
        </Paragraph>
...
export default KS_AWS_CT_00081;

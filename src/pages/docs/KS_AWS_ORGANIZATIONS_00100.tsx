...
export interface KS_AWS_ORGANIZATIONS_00100Props {}

const KS_AWS_ORGANIZATIONS_00100: React.FC<KS_AWS_ORGANIZATIONS_00100Props> = () => {
  return (
    <CustomFlexBox>
      <PageTitle title="Identity and Access Management | A change was performed on the aws account Alternate Contacts" />
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">A change was performed on the aws account Alternate Contacts</H1>
...
export default KS_AWS_ORGANIZATIONS_00100;

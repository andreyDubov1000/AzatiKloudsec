...
export interface KS_AWS_HEALTH_00120Props {}

const KS_AWS_HEALTH_00120: React.FC<KS_AWS_HEALTH_00120Props> = () => {
  return (
    <CustomFlexBox>
      <PageTitle title="Logging and Monitoring | AWS Health not enabled for the organization" />
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">AWS Health not enabled for the organization</H1>
		...
		AWS Health not enabled for the organization
        </Paragraph>
...
export default KS_AWS_HEALTH_00120;

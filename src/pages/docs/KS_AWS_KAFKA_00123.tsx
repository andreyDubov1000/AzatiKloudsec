...
export interface KS_AWS_KAFKA_00123Props {}

const KS_AWS_KAFKA_00123: React.FC<KS_AWS_KAFKA_00123Props> = () => {
  return (
    <CustomFlexBox>
      <PageTitle title="Data Protection | KAFKA cluster not encrypted using customer managed KEY" />
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">KAFKA cluster not encrypted using customer managed KEY</H1>
		...
		KAFKA cluster not encrypted using customer managed KEY
        </Paragraph>
...
export default KS_AWS_KAFKA_00123;

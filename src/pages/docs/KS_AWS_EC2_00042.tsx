...
export interface KS_AWS_EC2_00042Props {}

const KS_AWS_EC2_00042: React.FC<KS_AWS_EC2_00042Props> = () => {
  return (
    <CustomFlexBox>
      <PageTitle title="General | EC2 without any tag" />
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">EC2 without any tag</H1>
...
export default KS_AWS_EC2_00042;

...
export interface KS_AWS_DYNAMODB_00088Props {}

const KS_AWS_DYNAMODB_00088: React.FC<KS_AWS_DYNAMODB_00088Props> = () => {
  return (
    <CustomFlexBox>
      <PageTitle title="Data Protection | Dynamodb table is not encrypted" />
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">Dynamodb table is not encrypted</H1>
		...
		Dynamodb table is not encrypted
        </Paragraph>
...
export default KS_AWS_DYNAMODB_00088;

...
export interface KS_AWS_WORKSPACES_00113Props {}

const KS_AWS_WORKSPACES_00113: React.FC<KS_AWS_WORKSPACES_00113Props> = () => {
  return (
    <CustomFlexBox>
      <PageTitle title="Data Protection | Workspace User Volume not encrypted" />
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">Workspace User Volume not encrypted</H1>
		...
		Workspace User Volume not encrypted
        </Paragraph>
...
export default KS_AWS_WORKSPACES_00113;

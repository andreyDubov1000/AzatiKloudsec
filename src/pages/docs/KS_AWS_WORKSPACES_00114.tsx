...
export interface KS_AWS_WORKSPACES_00114Props {}

const KS_AWS_WORKSPACES_00114: React.FC<KS_AWS_WORKSPACES_00114Props> = () => {
  return (
    <CustomFlexBox>
      <PageTitle title="Data Protection | Workspace Root Volume not encrypted" />
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">Workspace Root Volume not encrypted</H1>
		...
		Workspace Root Volume not encrypted
        </Paragraph>
...
export default KS_AWS_WORKSPACES_00114;

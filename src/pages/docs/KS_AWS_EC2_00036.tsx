...
export interface KS_AWS_EC2_00036Props {}

const KS_AWS_EC2_00036: React.FC<KS_AWS_EC2_00036Props> = () => {
  return (
    <CustomFlexBox>
      <PageTitle title="Data Protection | Volume without backup or recent backup" />
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">Volume without backup or recent backup</H1>
		...
		Volume without backup or recent backup
        </Paragraph>
...
export default KS_AWS_EC2_00036;

...
export interface KS_AWS_KINESIS_00087Props {}

const KS_AWS_KINESIS_00087: React.FC<KS_AWS_KINESIS_00087Props> = () => {
  return (
    <CustomFlexBox>
      <PageTitle title="Data Protection | Kinesis stream is not encrypted" />
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">Kinesis stream is not encrypted</H1>
...
export default KS_AWS_KINESIS_00087;

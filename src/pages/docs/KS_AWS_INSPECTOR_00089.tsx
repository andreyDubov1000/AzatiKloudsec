...
export interface KS_AWS_INSPECTOR_00089Props {}

const KS_AWS_INSPECTOR_00089: React.FC<KS_AWS_INSPECTOR_00089Props> = () => {
  return (
    <CustomFlexBox>
      <PageTitle title="Infrastructure | Inspector assessment has not been executed in the last 7 days" />
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">Inspector assessment has not been executed in the last 7 days</H1>
		...
		Inspector assessment has not been executed in the last 7 days
        </Paragraph>
...
export default KS_AWS_INSPECTOR_00089;

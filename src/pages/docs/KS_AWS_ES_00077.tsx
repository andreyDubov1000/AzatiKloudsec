...
export interface KS_AWS_ES_00077Props {}

const KS_AWS_ES_00077: React.FC<KS_AWS_ES_00077Props> = () => {
  return (
    <CustomFlexBox>
      <PageTitle title="Data Protection | Elasticsearch HTTPS not configured" />
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">Elasticsearch HTTPS not configured</H1>
		...
		Elasticsearch HTTPS not configured
        </Paragraph>
...
export default KS_AWS_ES_00077;

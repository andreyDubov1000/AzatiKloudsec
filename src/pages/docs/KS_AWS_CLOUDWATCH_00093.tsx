...
export interface KS_AWS_CLOUDWATCH_00093Props {}

const KS_AWS_CLOUDWATCH_00093: React.FC<KS_AWS_CLOUDWATCH_00093Props> = () => {
  return (
    <CustomFlexBox>
      <PageTitle title="Data Protection | Unencrypted cloudwatch log group" />
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">Unencrypted cloudwatch log group</H1>
		...
		Unencrypted cloudwatch log group
        </Paragraph>
...
export default KS_AWS_CLOUDWATCH_00093;

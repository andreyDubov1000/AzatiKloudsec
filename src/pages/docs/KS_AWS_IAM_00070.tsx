...
export interface KS_AWS_IAM_00070Props {}

const KS_AWS_IAM_00070: React.FC<KS_AWS_IAM_00070Props> = () => {
  return (
    <CustomFlexBox>
      <PageTitle title="Data Protection | No MFA configured for the root account" />
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">No MFA configured for the root account</H1>
		...
		No MFA configured for the root account
        </Paragraph>
...
export default KS_AWS_IAM_00070;

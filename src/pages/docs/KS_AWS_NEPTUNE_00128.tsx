...
export interface KS_AWS_NEPTUNE_00128Props {}

const KS_AWS_NEPTUNE_00128: React.FC<KS_AWS_NEPTUNE_00128Props> = () => {
  return (
    <CustomFlexBox>
      <PageTitle title="Data Protection | Amazon Neptune database instance storage is not encrypted" />
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">Amazon Neptune database instance storage is not encrypted</H1>
...
export default KS_AWS_NEPTUNE_00128;

...
const KS_AWS_ACM_00118: React.FC<KS_AWS_ACM_00118Props> = () => {
  return (
    <CustomFlexBox>
      <PageTitle title="Data Protection | ACM Certificate will expire in the less than 30 days" />
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">ACM Certificate will expire in the less than 30 days</H1>
		...
		ACM Certificate will expire in the less than 30 days
        </Paragraph>

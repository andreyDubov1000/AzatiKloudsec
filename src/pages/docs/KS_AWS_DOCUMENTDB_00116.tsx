...
export interface KS_AWS_DOCUMENTDB_00116Props {}

const KS_AWS_DOCUMENTDB_00116: React.FC<KS_AWS_DOCUMENTDB_00116Props> = () => {
  return (
    <CustomFlexBox>
      <PageTitle title="Data Protection | DocumentDB Cluster storage is not encrypted" />
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">DocumentDB Cluster storage is not encrypted</H1>
		...
		DocumentDB Cluster storage is not encrypted
        </Paragraph>
...
export default KS_AWS_DOCUMENTDB_00116;

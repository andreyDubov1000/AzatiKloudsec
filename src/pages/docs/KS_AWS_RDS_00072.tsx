...
export interface KS_AWS_RDS_00072Props {}

const KS_AWS_RDS_00072: React.FC<KS_AWS_RDS_00072Props> = () => {
  return (
    <CustomFlexBox>
      <PageTitle title="Data Protection | Unencrypted RDS database" />
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">Unencrypted RDS database</H1>
...
export default KS_AWS_RDS_00072;

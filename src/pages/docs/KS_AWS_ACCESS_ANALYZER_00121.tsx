...
export interface KS_AWS_ACCESS_ANALYZER_00121Props {}

const KS_AWS_ACCESS_ANALYZER_00121: React.FC<KS_AWS_ACCESS_ANALYZER_00121Props> = () => {
  return (
    <CustomFlexBox>
      <PageTitle title="Data Protection | Access Analyzer has active findings" />
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">Access Analyzer has active findings</H1>
		...
		Access Analyzer has active findings
        </Paragraph>
...
export default KS_AWS_ACCESS_ANALYZER_00121;

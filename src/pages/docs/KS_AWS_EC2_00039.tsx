...
export interface KS_AWS_EC2_00039Props {}

const KS_AWS_EC2_00039: React.FC<KS_AWS_EC2_00039Props> = () => {
  return (
    <CustomFlexBox>
      <PageTitle title="Identity and Access Management | EC2 IMDSV2 is not enabled" />
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">EC2 IMDSV2 is not enabled</H1>
...
export default KS_AWS_EC2_00039;

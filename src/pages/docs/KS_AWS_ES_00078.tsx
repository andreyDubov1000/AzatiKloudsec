...
export interface KS_AWS_ES_00078Props {}

const KS_AWS_ES_00078: React.FC<KS_AWS_ES_00078Props> = () => {
  return (
    <CustomFlexBox>
      <PageTitle title="Data Protection | Elasticsearch old TLS version" />
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">Elasticsearch old TLS version</H1>
...
export default KS_AWS_ES_00078;

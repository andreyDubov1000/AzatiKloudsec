...
export interface KS_AWS_ELASTICACHE_00112Props {}

const KS_AWS_ELASTICACHE_00112: React.FC<KS_AWS_ELASTICACHE_00112Props> = () => {
  return (
    <CustomFlexBox>
      <PageTitle title="Data Protection | Elasticache Cluster is not encrypting data in transit" />
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">Elasticache Cluster is not encrypting data in transit</H1>
		...
		Elasticache Cluster is not encrypting data in transit
        </Paragraph>
...
export default KS_AWS_ELASTICACHE_00112;

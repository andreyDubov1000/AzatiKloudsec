...
export interface KS_AWS_EC2_00064Props {}

const KS_AWS_EC2_00064: React.FC<KS_AWS_EC2_00064Props> = () => {
  return (
    <CustomFlexBox>
      <PageTitle title="Data Protection | ELB with old TLS version" />
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">ELB with old TLS version</H1>
...
export default KS_AWS_EC2_00064;

...
export interface KS_AWS_ECS_00096Props {}

const KS_AWS_ECS_00096: React.FC<KS_AWS_ECS_00096Props> = () => {
  return (
    <CustomFlexBox>
      <PageTitle title="Data Protection | ECS task definition expose secrets" />
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">ECS task definition expose secrets</H1>
		...
		ECS task definition expose secrets
        </Paragraph>
...
export default KS_AWS_ECS_00096;

...
export interface KS_AWS_COMPREHEND_00124Props {}

const KS_AWS_COMPREHEND_00124: React.FC<KS_AWS_COMPREHEND_00124Props> = () => {
  return (
    <CustomFlexBox>
      <PageTitle title="Data Protection | Amazon Comprehend job output results data are not encrypted" />
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">Amazon Comprehend job output results data are not encrypted</H1>
...
export default KS_AWS_COMPREHEND_00124;

...
export interface KS_AWS_EC2_00034Props {}

const KS_AWS_EC2_00034: React.FC<KS_AWS_EC2_00034Props> = () => {
  return (
    <CustomFlexBox>
      <PageTitle title="Data Protection | Unencrypted volume" />
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">Unencrypted volume</H1>
...
export default KS_AWS_EC2_00034;

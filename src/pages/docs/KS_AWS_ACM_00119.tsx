...
export interface KS_AWS_ACM_00119Props {}

const KS_AWS_ACM_00119: React.FC<KS_AWS_ACM_00119Props> = () => {
  return (
    <CustomFlexBox>
      <PageTitle title="Data Protection | ACM Certificate Wildcard Usage" />
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">ACM Certificate Wildcard Usage</H1>
		...
		ACM Certificate Wildcard Usage
        </Paragraph>
...
export default KS_AWS_ACM_00119;

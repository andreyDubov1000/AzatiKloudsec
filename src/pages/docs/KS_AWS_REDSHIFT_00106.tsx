...
export interface KS_AWS_REDSHIFT_00106Props {}

const KS_AWS_REDSHIFT_00106: React.FC<KS_AWS_REDSHIFT_00106Props> = () => {
  return (
    <CustomFlexBox>
      <PageTitle title="Data Protection | Redshift cluster publicly accessible" />
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">Redshift cluster publicly accessible</H1>
...
export default KS_AWS_REDSHIFT_00106;

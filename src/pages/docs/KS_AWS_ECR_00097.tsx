...
export interface KS_AWS_ECR_00097Props {}

const KS_AWS_ECR_00097: React.FC<KS_AWS_ECR_00097Props> = () => {
  return (
    <CustomFlexBox>
      <PageTitle title="Data Protection | ECR repository publicly accessible" />
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">ECR repository publicly accessible</H1>
...
export default KS_AWS_ECR_00097;

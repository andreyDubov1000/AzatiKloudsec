...
export interface KS_AWS_KMS_00095Props {}

const KS_AWS_KMS_00095: React.FC<KS_AWS_KMS_00095Props> = () => {
  return (
    <CustomFlexBox>
      <PageTitle title="Infrastructure | Rotation for KMS key is disabled" />
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">Rotation for KMS key is disabled</H1>
		...
		Rotation for KMS key is disabled
        </Paragraph>
...
export default KS_AWS_KMS_00095;

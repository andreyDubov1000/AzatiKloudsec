...
export interface KS_AWS_IAM_00091Props {}

const KS_AWS_IAM_00091: React.FC<KS_AWS_IAM_00091Props> = () => {
  return (
    <CustomFlexBox>
      <PageTitle title="Data Protection | Root user activity detected" />
      <Card sx={{ flex: "1 1 0", p: "1.5rem", bgcolor: "white", m: "1rem" }}>
        <H1 mb="0.75rem">Root user activity detected</H1>
...
export default KS_AWS_IAM_00091;

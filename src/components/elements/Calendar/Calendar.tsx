...
const Calendar = ({ onChange, className, placeholder = 'From', initialDate, type = 'filled', ...props }: CalendarPropsTypes) => {
    ...
    <div className={styles.calendarInputContainer}>
      <svg
        ...
        className={classNames(styles.calendarIcon, {
          [styles.calendarIcon_filled]: type === 'filled' ? value : false,
          [styles.calendarIcon_outlined]: type === 'outlined',
        })}
      >
      ...
      <input
        className={classNames(styles.customInput, {
          [styles.customInput_filled]: type === 'filled' ? value : false,
          [styles.customInput_outlined]: type === 'outlined',
        })}
        value={value}
